...
const Home: React.FC = () => {
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 4 }}>
      {/* Header */}
      <Stack
        sx={{ mb: 4, direction: "row", alignItems: "center", justifyContent: "center", spacing: 2  }}
      >
        <SportsBasketballIcon sx={{ fontSize: 48, color: 'primary.main' }} />
        <Box>
          <Typography sx={{ variant: "h3", component: "h1", fontWeight: "bold" }}>
            NBA Players
          </Typography>
      ...
      {!isLoading && data && (
        <>
          ...
          {/* Results Info */}
          <Typography
            sx={{ fontVariant:"body2", color: "text.secondary", textAlign: "center", mt: 2}}
          >
